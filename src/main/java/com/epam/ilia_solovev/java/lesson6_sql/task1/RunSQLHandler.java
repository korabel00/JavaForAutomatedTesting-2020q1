/*      Solovev Ilia Lesson 6 Task 1
        ...
        date), Posts(id, userId), Likes (postid, likes).
        ...
        было больше 3 друзей в марте 2015 года и среднее количество лайков каждого
        поста (за весь период) лежит в диапазоне [2; 200). Отчет выводится на консоль. Все
